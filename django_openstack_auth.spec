...
Version  : 1.2.0
Release  : 14
URL      : http://tarballs.openstack.org/django_openstack_auth/django_openstack_auth-1.2.0.tar.gz
Source0  : http://tarballs.openstack.org/django_openstack_auth/django_openstack_auth-1.2.0.tar.gz
...
%prep
%setup -q -n django_openstack_auth-1.2.0
