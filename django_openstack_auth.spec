...
Version  : 2.1.1
Release  : 21
URL      : http://tarballs.openstack.org/django_openstack_auth/django_openstack_auth-2.1.1.tar.gz
Source0  : http://tarballs.openstack.org/django_openstack_auth/django_openstack_auth-2.1.1.tar.gz
...
%prep
%setup -q -n django_openstack_auth-2.1.1
